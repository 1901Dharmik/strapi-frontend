...
const Knowdetail = (propsk) => {
  ...
  return (
    <div>
      {/* <div class="container problem-section mx-4">
        <div class="row section-padding-top section-padding-bottom-30">
          <div class="col-md-6 content m-auto pad-right-10per">
            <h3 class="knowledge-heading">{propsk.tittle}</h3>
            <hr class="knowledge-hr digestive-kit-bg-color" />

            <p class="mt-15">{propsk.text}</p>
          </div>
          <div class="col-md-6 ">
            <img src={propsk.src} />
          </div>
        ...
        <div class="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">Stomach Gas</span>
      ...
      <div class="tab-section mb-4  border-b border-gray-200 dark:border-gray-700">
        <ul
          class="nav-tabs justify-center flex flex-wrap -mb-px text-sm font-medium sm:overflow-scroll text-center "
          id="myTab"
        ...
        >
          <li class="mr-2 nav-li" role="presentation">
            <button
              ...
              class="inline-block  p-4 tab-btn rounded-t-lg nav-link"
              id="profile-tab"
          ...
          <li class="mr-2" role="presentation">
            <button
              ...
              class="inline-block  p-4 tab-btn border-transparent rounded-t-lg nav-link"
              id="dashboard-tab"
              ...
              aria-selected="false"
            >
              <a href="#Exercise"></a> Exercise
            </button>
          </li>
          <li class="mr-2 " role="presentation">
            <button
              onClick={() => updateToggle(3)}
              className="inline-block p-4 tab-btn border-transparent rounded-t-lg nav-link"
              id="settings-tab"
      ...
      <div id="myTabContent" className="contant-section">
        <div
          ...
          className={toggle === 1 ? "show-contatent" : "hidden"}
        >
        ...
        <div
          ...
          className={toggle === 2 ? "show-contatent" : "hidden"}
        >
        ...
        <div
          ...
          className={toggle === 3 ? "show-contatent" : "hidden"}
        >
          <p class="text-sm text-gray-500 dark:text-gray-400">
            This is some placeholder content the{" "}
            <strong class="font-medium text-gray-800 dark:text-white">
        ...
        <div
          ...
          className={toggle === 4 ? "show-contatent" : "hidden"}
        >
          <p class="text-sm text-gray-500 dark:text-gray-400">
            This is some placeholder content the{" "}
            <strong class="font-medium text-gray-800 dark:text-white">
