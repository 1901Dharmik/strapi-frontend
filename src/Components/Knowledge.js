...
import Tittle from './Head/Tittle';
// import Knowdetail from '../components/Knowdetail';
import Knowdetail from './Knowledge-Center/Knowdetail';
...
const Knowledge = () => {
  ...
  return (
    <div >
      ...
      <div className='drop-with-tab-section'>
        <div class="knowledge-banner">
          {/* <img class="mob-hide" src={images[selectedItem]} alt="VigyanVeda Constipation Banner" /> */}
          {
            selectedItem === '' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/Knowledge_Center_banner_3.jpg?v=1645100614' alt="Selected Image" />
            </div>
          }
          {
            selectedItem === 'item1' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/Knowledge_Center_banner_3.jpg?v=1645100614' alt="Selected Image" />
            </div>
          } {
            selectedItem === 'item2' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/Knowledge_Center_banner_a4b79260-4d3e-4896-a8c6-d656844a2f6f.jpg?v=1645009992' alt="Selected Image" />
            </div>
          } {
            selectedItem === 'item3' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/5-min.jpg?v=1644670489' alt="Selected Image" />
            </div>
          }{
            selectedItem === 'item4' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/KC-_Banner_Nutrition_Care.jpg?v=1644833640' alt="Selected Image" />
            </div>
          }{
            selectedItem === 'item5' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/KC-_Banner_-_Immunity_Care.jpg?v=1644833640' alt="Selected Image" />
            </div>
          }{
            selectedItem === 'item6' && <div>
              <img src='https://cdn.shopify.com/s/files/1/0575/8920/3125/files/Knowledge_Center_banner_2.jpg?v=1644849809' alt="Selected Image" />
            </div>
          }{
            selectedItem === 'item7' && <div>
        ...
        <div className='container-main' >
          <div className='drop-with-tab'>
            <div className=' left-dropdown-part '>
              <select className=' mydropdown' value={selectedItem} onChange={handleChange}>

                {/* <option value="">Select Your Care</option> */}
                <option value="item1">Digesive Care</option>
            ...
            <div className='right-tab-list-part'>
              {selectedItem === 'item1' && <div>
                ...
                <div id="Digestive_Care" >
                  ...
                  <span onClick={() => handleClick(1)} ><a href='#Stomach Gas'
                    class="digestive-kit"> Stomach Gas </a>



                  </span >
                  <span onClick={() => handleClick(2)}><a href='#Acidity'>
                    Acidity </a>
                  </span>
                  <span onClick={() => handleClick(3)}><a href='#Constipation'>

                    Constipation </a></span>
                </div>
              </div>}
              {selectedItem === 'item2' && <div><div id="Piles_care" >
                <span onClick={() => handleClick(4)}><a href='#Piles'> Piles
                </a></span>
                <span onClick={() => handleClick(5)}><a href='#Fissure'>
                  Fissure </a></span>
                <span onClick={() => handleClick(6)}><a href='#Fistula'>
                  Fistula </a></span>
              </div></div>}
              {selectedItem === 'item3' && <div><div id="Weight_care" >
                <span onClick={() => handleClick(7)}><a href='#Weight Loss'>Weight
                  Loss</a></span>
                <span onClick={() => handleClick(8)}><a href='#Weight Gain'>Weight
                  Gain</a></span>
              </div></div>}
              {selectedItem === 'item4' && <div><div id="Nutrition_care" >
                <span onClick={() => handleClick(9)}><a
                >
                  Nutrition Deficiency </a></span>
              </div></div>}
              {selectedItem === 'item5' && <div><div id="Immuntiy_care" >
                <span onClick={() => handleClick(10)}><a href='#Low Immunitty'
                >
                  Low Immunity </a></span>
              </div></div>}
              {selectedItem === 'item6' && <div><div id="Women_wellness" >
                <span onClick={() => handleClick(11)}><a href='#Irregular Periods'
                >
                  Irregular Periods </a></span>
                <span onClick={() => handleClick(12)}><a href='#Menopause'>
                  Menopause </a></span>
                <span onClick={() => handleClick(13)}><a href='#PCOS/PCOD '>
                  PCOS/PCOD </a></span>
              </div></div>}
              {selectedItem === 'item7' && <div><div id="Sexual_care" >
                <span onClick={() => handleClick(14)}><a href='#Premature
                  Ejaculation'> Premature
                  Ejaculation </a></span>
                <span onClick={() => handleClick(15)}><a href='#Low Libido'>
                  Low Libido </a></span>
                <span onClick={() => handleClick(16)}><a href='#Erectile
                  Dysfunction'> Erectile
                  Dysfunction </a></span>
                <span onClick={() => handleClick(17)}><a href='#Nightfall'>
                  Nightfall </a></span>
              </div></div>}
            </div>
